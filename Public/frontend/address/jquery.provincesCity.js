...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<select name='accept_province' class='accept_province'></select>");
	_self.append("<select name='accept_city'></select>");
	_self.append("<select name='accept_town'></select>");
	//分别获取3个下拉框
