...
<body>
 <div class="wrap">
  <div class="page-title">
    ...
    <span class="modular fr"><a href="<?php echo U('Login/add_user');?>" class="pt-link-btn">+添加新会员</a></span>
  </div>
  <div class="operate">
   <form>
<!--     <select class="inline-select">
  ...
  <table class="list-style Interlaced">
   ...
   <?php if(is_array($user)): foreach($user as $key=>$v): ?><tr>
    <td>
     <input type="checkbox"/>
     <span class="middle"><?php echo ($v["admin_id"]); ?></span>
    </td>
    <td class="center"><?php echo ($v["admin_name"]); ?></td>
    <td class="center"><?php echo ($v["admin_email"]); ?></td>
    ...
    <td class="center"><?php echo ($v["start_time"]); ?></td>
    <td class="center">
     <a href="<?php echo U('Login/edit_user');?>" class="inline-block" title="编辑"><img src="images/icon_edit.gif"/></a>
